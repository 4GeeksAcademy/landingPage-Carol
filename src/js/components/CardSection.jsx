...
export const CardSection = () => {
    const lugares = [
        ...
        {
            id: "sierra-nevada",
            url: "https://es.wikipedia.org/wiki/Estaci%C3%B3n_de_esqu%C3%AD_de_Sierra_Nevada",
        ...
        {
            id: "sacromonte",
            url: "https://es.wikipedia.org/wiki/Sacromonte",
        ...
        {
            id: "hammam",
            url: "https://es.wikipedia.org/wiki/El_Ba%C3%B1uelo",
